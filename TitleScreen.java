...
public class TitleScreen extends Window implements EventListener {
    ...
    public TitleScreen() {
        ...
        // Add all the buttons
        easy = new Button(350, 120, 160, 40, "1 - Easy");
        okay = new Button(350, 170, 160, 40, "2 - Medium");
        hard = new Button(350, 220, 160, 40, "3 - Hard");
        quit = new Button(350, 300, 160, 40, "Q - Quit");
        ...
        Label title = new Label(300, 70, "Help Mario Find The Poison Mushrooms!");
        title.setFont("SansSerif Bold", 22);
        title.setForegroundColor(Canvas.RED);
        add(title);
    }
    ...
    public void repaintWindowBackground(GUI.Canvas canvas) {
        ...
        canvas.picture(70, 100, "mario.jpg", 230, 250);
    ...
    private void setRandomColor(Canvas canvas, int r, int i, int j) {
        ...
        h = h ^ (h >> 8);
        switch(h % 97) {
            case 0:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 1:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 2:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 3:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 4:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 5:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 6:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 7:  canvas.setPenColor(Canvas.DARK_RED); break;
            case 8:  canvas.setPenColor(Canvas.DARK_RED); break;
            default: canvas.setPenColor(Canvas.DARK_GRAY); break;
        }
    }
